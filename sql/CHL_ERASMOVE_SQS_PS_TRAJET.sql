...
BEGIN
    SELECT TRJ.TRJ_ID, TRJ.LIE_ID_DEPART,
           LD.LIE_NOM AS NOM_DEPART, LD.LIE_VILLE AS VILLE_DEPART, LD.LIE_PAYS AS PAYS_DEPART,
           LD.LIE_LATITUDE AS LAT_DEPART, LD.LIE_LONGITUDE AS LON_DEPART,
           TRJ.LIE_ID_ARRIVEE, LA.LIE_NOM AS NOM_ARRIVEE, LA.LIE_VILLE AS VILLE_ARRIVEE, LA.LIE_PAYS AS PAYS_ARRIVEE,
