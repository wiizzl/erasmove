...
/* =========================================================================
   ...
   ========================================================================= */
CREATE PROCEDURE PSS_VOYAGE_ITINERARY
    @VOY_ID INT
AS
BEGIN
    SELECT VE.VET_ORDRE,
           LD.LIE_NOM AS NOM_DEPART, LD.LIE_LATITUDE AS LAT_DEPART, LD.LIE_LONGITUDE AS LON_DEPART,
           LA.LIE_NOM AS NOM_ARRIVEE, LA.LIE_LATITUDE AS LAT_ARRIVEE, LA.LIE_LONGITUDE AS LON_ARRIVEE,
